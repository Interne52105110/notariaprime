  ...
  return (
    <>
      <CalculatorJsonLd
        ...
        description="Simulez la fiscalité de votre contrat d'assurance vie : versements avant/après 70 ans, abattement 152 500 €, prélèvement 20%/31,25%, transmission. Gratuit, conforme 2026."
        path="/assurance-vie"
      />
      {children}
    </>
